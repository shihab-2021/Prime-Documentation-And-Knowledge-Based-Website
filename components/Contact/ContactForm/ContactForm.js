                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5 bg-white'>
                    <div className='p-10'>
                        ...
                        <form onSubmit={handleSubmit} className='grid grid-cols-1 lg:grid-cols-2 gap-3'>
                            <div>
                                <label >First Name
                                    <input name='firstname' type="text" required placeholder='Enter Your First name ' className='block w-full border rounded mt-2 h-10 ' />
                                </label>
                            </div>
                            <div>
                                <label >Last Name
                                    <input name='lastname' type="text" required placeholder='Enter Your Last Name' className='block w-full border rounded mt-2 h-10' />
                                </label>
                            </div>
                            <div>
                                <label >Email
                                    <input name='email' type="email" required placeholder='Enter Your Email' className='block w-full border rounded mt-2 h-10' />
                                </label>
                            </div>
                            <div>
                                <label >Subject
                                    <input name='subject' type="text" required placeholder='Enter Your Subject' className='block w-full border rounded mt-2 h-10' />
                                </label>
                            </div>
                            <div className='col-span-2'>
                                <label >Your Message

                                    <textarea name='message' type="text" required placeholder='Enter Your Message' className='block w-full border rounded mt-2'></textarea>
                                </label>
                            </div>
                            <button
                                type="submit"
